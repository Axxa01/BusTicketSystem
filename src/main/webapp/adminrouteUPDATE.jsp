                            ...
                            <div class="card-body">
                                <br>
                                  ...
                                  try {
                                      ...
                                      String sql = "SELECT * FROM route WHERE route_id = CAST(? AS BIGINT)";
                                ...
                                <form method="POST" action="routeServlet">
                                 <input type="hidden" class="form-control"  name="command" value="update"  >

                                <div class="row mb-3">
                                        <div class="col-lg-3">
                                            <label for="nameInput" class="form-label">Route No</label>
                                        </div>
                                        <div class="col-lg-9">
                                                <input type="text" class="form-control" id="nameInput" name=""  value=" MYSR <%=routeId%>" readonly >
                                        </div>
                                    </div>
                                                  <input type="hidden" class="form-control" id="nameInput" name="routeid"  value="<%=routeId%>" readonly >
                                ...
                                <br>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                                <input type="text" class="form-control" id="nameInput" name="fromRoute"  value="<%=from%>"  >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-9">
                                                <input type="text" class="form-control" id="nameInput" name="toRoute"   value="<%=to%>"  >
                                        </div>
                                    </div>
                                ...
                                <br> 
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                                <input type="Date" class="form-control" id="nameInput" name="fromDate"   value="<%=startdate%>"  >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-9">
                                                <input type="Date" class="form-control" id="nameInput" name="toDate"   value="<%=enddate%>"  >
                                        </div>
                                    </div>
